...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
		...
		(0, _jquery2.default)(document).on('scroll', function () {
			(0, _jquery2.default)('.reads').each(function () {
				var self = (0, _jquery2.default)(this),
				    height = self.offset().top + self.height();
				if ((0, _jquery2.default)(document).scrollTop() + windowHeight >= height) {
					tl.staggerFromTo('.reads__content .reads__wrap', 3, { opacity: 0, rotation: 500 }, { opacity: 1, rotation: 0, scale: 1, ease: Bounce.easeOut }, '-=2', .7);
				}
			});
		});
	});
...
//# sourceMappingURL=0.3319273447180c8fcee0.hot-update.js.map