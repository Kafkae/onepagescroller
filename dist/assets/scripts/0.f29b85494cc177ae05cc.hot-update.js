...
/***/ (function(module, exports, __webpack_require__) {
	...
	var scence = new _ScrollMagic2.default.Scene({
		triggerElement: "#header".setTween('.header__intro', 1, { x: -200, opacity: 0 }, { x: 0, opacity: 1, ease: Bounce.easeOut }, '-=1').setTween('.header__media', 1, { x: 200, opacity: 0 }, { x: 0, opacity: 1, ease: Bounce.easeOut }, '-=1')
	});
...
//# sourceMappingURL=0.f29b85494cc177ae05cc.hot-update.js.map