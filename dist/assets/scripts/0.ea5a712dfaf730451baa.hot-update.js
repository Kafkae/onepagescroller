							...
							afterLoad: function afterLoad(anchorLink, index) {
										switch (index) {
													...
													case 3:
																...
																TweenMax.from(block3, 2, { x: 300, y: -130, immediateRender: true });
																TweenMax.from(block2, 2, { y: 130, x: -250, immediateRender: true });
																TweenMax.from(block4, 2, { y: -130, x: -250, immediateRender: true });
																break;
...
//# sourceMappingURL=0.ea5a712dfaf730451baa.hot-update.js.map