			...
			afterLoad: function afterLoad(anchorLink, index) {
				switch (index) {
					...
					case 3:
						...
						TweenMax.from(block1, 1, { x: 300, y: 130, immediateRender: true, ease: Bounce.easeOut });
						TweenMax.from(block3, 1, { x: 300, y: -130, immediateRender: true, ease: Bounce.easeOut });
						TweenMax.from(block2, 1, { y: 130, x: -250, immediateRender: true, ease: Bounce.easeOut });
						TweenMax.from(block4, 1, { y: -130, x: -250, immediateRender: true, ease: Bounce.easeOut });
						break;
					case 4:
						var block1 = (0, _jquery2.default)('.present-gallery__part_js-1');
						TweenMax.from(block1, 2, { x: 300, y: 130, immediateRender: true });
						break;
				}
			}
		});
...
//# sourceMappingURL=0.f38b05065fd12a054b57.hot-update.js.map