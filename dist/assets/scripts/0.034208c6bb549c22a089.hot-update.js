							...
							afterLoad: function afterLoad(anchorLink, index) {
										switch (index) {
													...
													case 3:
																...
																TweenMax.from(block1, 2, { x: 300, y: 120, immediateRender: true });
																TweenMax.from(block3, 2, { x: 300, y: -120, immediateRender: true });
																TweenMax.from(block2, 2, { y: 120, x: -250, immediateRender: true });
																TweenMax.from(block4, 2, { y: -120, x: -250, immediateRender: true });
																break;
...
//# sourceMappingURL=0.034208c6bb549c22a089.hot-update.js.map