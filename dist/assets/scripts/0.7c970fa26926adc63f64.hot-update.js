...
/***/ (function(module, exports, __webpack_require__) {
	...
	tl.fromTo('.logo', 0.5, { y: -200, opacity: 0 }, { y: 0, opacity: 1 }).fromTo('.burger', 1, { y: -200, opacity: 0 }, { y: 0, opacity: 1 });
	
	var tl = new _gsap.TimelineMax();
	var ctrl = new _ScrollMagic2.default.Controller();
	
	var scence = new _ScrollMagic2.default.Scene({
		triggerElement: ".header".fromTo('.header__intro', 1, { x: -200, opacity: 0 }, { x: 0, opacity: 1, ease: Bounce.easeOut }, '-=1').fromTo('.header__media', 1, { x: 200, opacity: 0 }, { x: 0, opacity: 1, ease: Bounce.easeOut }, '-=1')
	});
...
//# sourceMappingURL=0.7c970fa26926adc63f64.hot-update.js.map