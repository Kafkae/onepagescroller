...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $myElem = (0, _jquery2.default)('#myElem');
	(0, _jquery2.default)(window).scroll(function () {
		if ((0, _jquery2.default)(window).scrollTop() >= (0, _jquery2.default)($myElem).offset().top) {
			var _tl = new _gsap.TimelineMax();
			_tl.staggerFromTo('.reads__content .reads__wrap', 3, { opacity: 0, rotation: 500 }, { opacity: 1, rotation: 0, scale: 1, ease: Bounce.easeOut });
		}
	});

/***/ })
])
//# sourceMappingURL=0.2112b5448b145627440c.hot-update.js.map