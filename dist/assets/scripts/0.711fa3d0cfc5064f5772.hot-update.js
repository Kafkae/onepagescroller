	      ...
	      afterLoad: function afterLoad(anchorLink, index) {
	         switch (index) {
	            ...
	            case 2:
	               ...
	               break;
	            case 3:
	               var block1 = jQuery('.present-gallery__part_js-1');
	               var block2 = jQuery('.present-gallery__part_js-2');
	               var block3 = jQuery('.present-gallery__part_js-3');
	               var block4 = jQuery('.present-gallery__part_js-4');
	               TweenMax.set(block1, 2, { y: -200, opacity: 0, autoAlpha: 0, immediateRender: true });
	               break;
	         }
	      }
	   });
...
//# sourceMappingURL=0.711fa3d0cfc5064f5772.hot-update.js.map