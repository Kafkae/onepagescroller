...
/***/ (function(module, exports, __webpack_require__) {
	...
	tl.fromTo('.logo', 1, { y: -200, opacity: 0 }, { y: 0, opacity: 1 }).fromTo('.burger', 1, { y: -200, opacity: 0 }, { y: 0, opacity: 1 }).staggerFromTo('.navigation__panel .navigation__elem', 0.8, { opacity: 0, x: 30 }, { opacity: 1, x: 0 }, .5);
...
//# sourceMappingURL=0.f43f071a21963108d9bf.hot-update.js.map